  ...
  <React.Fragment>
    <CardContent>
      ...
      <Typography variant="h5" component="div">
        ...
        <span style={{ color: "#8B8000" }}>5: No Data Found</span>
      </Typography>
    </CardContent>
  </React.Fragment>
)
...
const Metrics: React.FC = () => {
  ...
  const dashboardMenuItem = {
    ...
    label: "Monitoring",
    link: "/monitoring",
    icon: SiGoogleanalytics, // Replace with your actual icon component
  }
  const dashboardConfigItem = {
    id: 2,
    label: "Configuration",
    link: "/configruation",
    icon: GoSettings, // Replace with your actual icon component
  }
